...
def get_athena_data():
    athena = boto3.client('athena', 
                      ...
                      aws_access_key_id='AKIAQO5JQOLJMOFXDUVA', 
                      aws_secret_access_key='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')
...
def send_message(recipient_id, message):
    ...
    response = requests.post('https://graph.facebook.com/v13.0/me/messages?access_token=' + 'EABWZBaMP5Mk8BAHTilO1MDqQK1mQLQbBfYWwc5BMKuwSJo3Aa29glsDSRgryPlC1nstP9XqniRmsbC3Mn5ZBO563H1Cu8enyrBGZC8Ji4ihBW7FKHaEXHcMdrA1jVLZA5m3Y1pfO9JAsHCSKjZC8YZAZBkM2HHrHMrVAUDYhfgq03MyjyVQFC7ZA', json=data)

# Function to get a connection to the database
def get_db_connection():
    try:
        conn = psycopg2.connect(
            dbname="totallyairdb-rds",
            user="adminair",
            password="airadmin",
            host="totallyairdb-rds.cynam4burbb0.us-east-1.rds.amazonaws.com",
            port="5432"
        )
        return conn
    except Error as e:
...
def verify():
    ...
    if request.args.get("hub.mode") == "subscribe" and request.args.get("hub.challenge"):
        if not request.args.get("hub.verify_token") == "dapmjd64840a6d4za89":
...
def query_data_for_department(department_number):
    ...
    s3 = boto3.client('s3', 
                        region_name='us-east-1', 
                        aws_access_key_id='AKIAQO5JQOLJLRY45YXB', 
                        aws_secret_access_key='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')
    # Get today's date
    today = datetime.now()
