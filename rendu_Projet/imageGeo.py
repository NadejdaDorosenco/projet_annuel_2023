...
class ImageAnalysis:
    ...
    def runImage(self):
        ...
        with rasterio.open(r"C:\Users\sofia\Desktop\4iabd\pa\data\image\data\ile_de_france", "w", **out_meta) as dest:
            dest.write(out_image)

        # Open the new TIFF file and display the image
        with rasterio.open(r"C:\Users\sofia\Desktop\4iabd\pa\data\image\data\ile_de_france") as src:
            # Create a plot
            fig, ax = plt.subplots()
